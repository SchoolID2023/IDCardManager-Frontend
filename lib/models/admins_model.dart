...
AdminsModel adminsModelFromJson(String str) =>
    AdminsModel.fromJson(json.decode(str));
...
class AdminsModel {
  ...
  factory AdminsModel.fromJson(Map<String, dynamic> json) => AdminsModel(
        ...
        schoolAdmins: List<SchoolAdmin>.from(
            json["schoolAdmins"].map((x) => SchoolAdmin.fromJson(x))),
      );
